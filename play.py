...
def _titles() -> list[Title]:
    ...
    return [
        ...
        Title(
            id="flappy", name="Flappy", entry=g / "flappy" / "flappy.py",
        ...
        Title(
            id="flappy-report", name="Flappy run diagnostics",
        ...
        Title(
            id="sling-report", name="Sling run diagnostics",
        ...
        Title(
            id="punchy-report", name="Punchy run diagnostics",
